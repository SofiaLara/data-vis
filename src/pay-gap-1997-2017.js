function PayGapTimeSeries(four) {
  ...
  this.layout = {
    ...
    rightMargin: four.width - marginSize,
    topMargin: marginSize,
    bottomMargin: four.height - marginSize * 2,
    pad: 5,
  ...
  this.draw = function () {
    ...
    for (var i = 0; i < this.data.getRowCount(); i++) {
      ...
      if (previous != null) {
        ...
        // year pay gap.
        four.stroke(0);
        four.line(this.mapYearToWidth(previous.year),
        ...
        var xLabelSkip = four.ceil(numYears / this.layout.numXTickLabels);

        // Draw the tick label marking the start of the previous year.
        if (i % xLabelSkip == 0) {
          drawXAxisTickLabel(previous.year, this.layout,
            this.mapYearToWidth.bind(this), four);
        }
      }
  ...
  this.drawTitle = function () {
    ...
    four.text(this.title,
      (this.layout.plotWidth() / 2) + this.layout.leftMargin,
      this.layout.topMargin - (this.layout.marginSize / 2));
  };

  this.mapYearToWidth = function (value) {
    return four.map(value,
      this.startYear,
      this.endYear,
